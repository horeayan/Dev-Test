using { genAIHubAHSrv } from '../srv/service.cds';

annotate genAIHubAHSrv.CustomerMessages with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate genAIHubAHSrv.CustomerMessages with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate genAIHubAHSrv.CustomerMessages with @UI.Identification: [{ Value: customerMessageID }];
annotate genAIHubAHSrv.CustomerMessages with {
...
annotate genAIHubAHSrv.CustomerMessages with @UI.LineItem: [
...
annotate genAIHubAHSrv.CustomerMessages with @UI.FieldGroup #Main: {
...
annotate genAIHubAHSrv.CustomerMessages with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate genAIHubAHSrv.CustomerMessages with @UI.SelectionFields: [
  customerMessageID
];
